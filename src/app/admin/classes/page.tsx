...
export default function AdminClassesPage() {
  ...
  const handleOpenDialog = (danceClass: DanceClass | null = null) => {
    ...
    if (danceClass) {
      form.reset({
        ...danceClass,
        type: danceClass.type as ClassType,
        date: danceClass.date && danceClass.date !== 'null' ? parseISO(danceClass.date) : undefined,
        capacity: danceClass.capacity || undefined,
        rentalContact: danceClass.rentalContact || undefined,
        rentalPrice: danceClass.rentalPrice || undefined,
        workshopPaymentValue: danceClass.workshopPaymentValue || undefined,
        workshopPaymentType: (danceClass.workshopPaymentType as any) || 'fixed',
        ...
        styleId: danceClass.styleId || undefined,
        levelId: danceClass.levelId || undefined,
        day: danceClass.day || undefined,
      });
    } else {
      form.reset({
        name: '',
